...
const AuctionWorkspace = ({ mode, profile, draft, previousAuctions, onUpdateDraft, onSchedule, onDeleteAuction, onEditAuction, onNavigate }) => {
    ...
    const renderPreviousAuctions = () => {
        ...
        return (_jsx("div", { className: "table-wrapper", children: _jsxs("table", { className: "table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "ID" }), _jsx("th", { children: "Status" }), _jsx("th", { children: "Type" }), _jsx("th", { children: "Item" }), _jsx("th", { children: "Current bid" }), _jsx("th", { children: "Bidder" }), _jsx("th", { children: "Ends" }), _jsx("th", { children: "Actions" })] }) }), _jsx("tbody", { children: previousAuctions.map((auction) => (_jsxs("tr", { children: [_jsx("td", { children: auction.id }), _jsx("td", { children: _jsx("span", { className: `status-chip ${auction.status}`, children: auction.status.charAt(0).toUpperCase() + auction.status.slice(1) }) }), _jsx("td", { children: auction.type === 'live' ? 'Live feed' : 'Post' }), _jsx("td", { children: auction.itemName || '-' }), _jsxs("td", { children: [profile.currency, " ", (auction.currentBid ?? auction.startingPrice).toFixed(2)] }), _jsx("td", { children: auction.leadingBidder || '-' }), _jsx("td", { children: formatDateTime(auction.endDateTime) }), _jsx("td", { children: _jsxs("div", { className: "table-actions", children: [_jsx("button", { type: "button", className: "icon-button", onClick: () => onEditAuction(auction), "aria-label": "Edit auction", title: "Edit auction", children: "\u270F\uFE0F" }), _jsx("button", { type: "button", className: "icon-button danger", onClick: () => onDeleteAuction(auction.id), "aria-label": "Delete auction", title: "Delete auction", children: "\uD83D\uDDD1\uFE0F" })] }) })] }, auction.id))) })] }) }));
    };
    if (!isCreationMode) {
        return _jsx("section", { className: "panel-card", children: renderPreviousAuctions() });
    }
    return (_jsxs("div", { className: "workspace-columns", children: [_jsxs("section", { className: "panel-card", children: [_jsxs("div", { className: "panel-header", children: [_jsx("h2", { children: mode === 'create-live' ? 'Live auction setup' : 'Post auction setup' }), _jsx("span", { children: "Capture the essentials and save this drop to the tracker" })] }), _jsxs("div", { className: "form-grid", children: [_jsxs("div", { className: "form-grid two-columns", children: [_jsxs("div", { children: [_jsx("label", { className: "field-label", htmlFor: "itemNameDraft", children: "Auction title" }), _jsx("input", { id: "itemNameDraft", value: draft.itemName, onChange: (event) => onUpdateDraft({ itemName: event.target.value }), placeholder: "e.g. Sapphire Cocktail Ring" })] }), isPostMode && (_jsxs("div", { children: [_jsx("label", { className: "field-label", htmlFor: "postUrl", children: "Facebook post URL" }), _jsx("input", { id: "postUrl", type: "url", placeholder: "https://www.facebook.com/groups/.../posts/...", value: draft.postUrl ?? '', onChange: (event) => onUpdateDraft({ postUrl: event.target.value }) }), _jsx("p", { className: "helper-text", children: "Needed so the tracker can monitor bids for this post." })] }))] }), _jsxs("div", { children: [_jsx("label", { className: "field-label", htmlFor: "description", children: "Description" }), _jsx("textarea", { id: "description", rows: 3, value: draft.description, onChange: (event) => onUpdateDraft({ description: event.target.value }), placeholder: "Share item specifics, shipping info, payment terms, and auction rules." })] }), _jsxs("div", { className: "form-grid two-columns", children: [_jsxs("div", { children: [_jsxs("label", { className: "field-label", htmlFor: "reserve", children: ["Reserve price (", profile.currency, ")"] }), _jsx("input", { id: "reserve", type: "number", min: 0, value: draft.reservePrice, onChange: (event) => onUpdateDraft({ reservePrice: Number(event.target.value) }) })] }), _jsxs("div", { children: [_jsxs("label", { className: "field-label", htmlFor: "starting", children: ["Starting price (", profile.currency, ")"] }), _jsx("input", { id: "starting", type: "number", min: 0, value: draft.startingPrice, onChange: (event) => onUpdateDraft({ startingPrice: Number(event.target.value) }) })] })] }), _jsxs("div", { className: "form-grid two-columns", children: [_jsxs("div", { children: [_jsxs("label", { className: "field-label", htmlFor: "bidIncrement", children: ["Bid increment (", profile.currency, ")"] }), _jsx("input", { id: "bidIncrement", type: "number", min: 1, value: draft.bidIncrement, onChange: (event) => onUpdateDraft({ bidIncrement: Number(event.target.value) }) })] }), _jsxs("div", { children: [_jsx("label", { className: "field-label", htmlFor: "endDate", children: "Auction end date" }), _jsx("input", { id: "endDate", type: "date", value: endDateValue, onChange: (event) => handleEndDateChange(event.target.value) })] })] }), _jsxs("div", { className: "form-grid two-columns", children: [_jsxs("div", { children: [_jsx("label", { className: "field-label", htmlFor: "endTime", children: "Auction end time" }), _jsx("input", { id: "endTime", type: "time", value: endTimeValue, onChange: (event) => handleEndTimeChange(event.target.value) }), _jsxs("p", { className: "helper-text", children: ["Times are displayed in your timezone (", profile.timeZone, ")."] })] }), _jsxs("div", { children: [_jsx("label", { className: "field-label", htmlFor: "gramWeight", children: "Gram weight" }), _jsx("input", { id: "gramWeight", type: "number", min: 0, step: 0.01, value: draft.gramWeight ?? '', onChange: (event) => handleGramChange(event.target.value), placeholder: "e.g. 0.85" }), _jsx("p", { className: "helper-text", children: "Carat value updates automatically when you edit grams." })] })] }), _jsxs("div", { className: "form-grid two-columns", children: [_jsxs("div", { children: [_jsx("label", { className: "field-label", htmlFor: "caratWeight", children: "Carat weight" }), _jsx("input", { id: "caratWeight", type: "number", min: 0, step: 0.01, value: draft.caratWeight ?? '', onChange: (event) => handleCaratChange(event.target.value), placeholder: "e.g. 4.25" })] }), mode === 'create-live' && (_jsxs("div", { children: [_jsx("label", { className: "field-label", htmlFor: "interval", children: "Interval between items (minutes)" }), _jsx("input", { id: "interval", type: "number", min: 1, value: draft.intervalBetweenItems ?? 4, onChange: (event) => onUpdateDraft({ intervalBetweenItems: Number(event.target.value) }) }), _jsx("p", { className: "helper-text", children: "Controls pacing for your live sequence." })] }))] }), mode === 'create-live' && (_jsxs("div", { children: [_jsx("label", { className: "field-label", htmlFor: "autoClose", children: "Auto close after (minutes)" }), _jsx("input", { id: "autoClose", type: "number", min: 5, value: draft.autoCloseMinutes ?? 60, onChange: (event) => onUpdateDraft({ autoCloseMinutes: Number(event.target.value) }) })] })), _jsxs("div", { className: "inline-actions", children: [_jsx("div", { children: _jsx("p", { className: "helper-text", children: disableSchedule
